...
BETTER_AUTH_SECRET=dev-secret-spexs-challenge-local-only-32chars
BETTER_AUTH_URL=http://localhost:3001
FRONTEND_URL=http://localhost:3000
REDIS_HOST=localhost
REDIS_PORT=6379
SEND_EMAILS=false
FROM_EMAIL=hello@spexs.local
```
...
| Email                                         | Password                |
| --------------------------------------------- | ----------------------- |
| [alice@example.com](mailto:alice@example.com) | `Sp3xs!Alice#2026$Demo` |
| [bob@example.com](mailto:bob@example.com)     | `Sp3xs!Bob#2026$Test`   |
